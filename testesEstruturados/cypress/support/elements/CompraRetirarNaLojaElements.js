class CompraRetirarNaLojaElements {
    ...
    confirmWithdrawShop = () => {return 'button[data-click="confirmarEntregaBalcao"]'}
    ...
    creditCardExpiryMonth = () => {return 'select[name="input-card-month-expiry"]'}
    creditCardExpiryYear = () => {return 'select[name="input-card-expiry"]'}
